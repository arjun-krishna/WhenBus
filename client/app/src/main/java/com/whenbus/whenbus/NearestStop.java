...
//        currentLocation = location;
        ...
        if(map != null) {
            ...
            options.position(userLatLng).title("User location");
//            options.icon(BitmapDescriptorFactory.fromResource(R.drawable.pin_red));
...
//        Toast.makeText(getBaseContext(),currentLat+"-"+currentLon, Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        options.icon(BitmapDescriptorFactory.fromResource(R.drawable.stop_board_red));
